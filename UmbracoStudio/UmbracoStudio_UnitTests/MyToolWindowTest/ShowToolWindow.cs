...
using Umbraco.UmbracoStudio;

namespace UmbracoStudio_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new UmbracoStudioPackage() as IVsPackage;
            ...
            MethodInfo method = typeof(UmbracoStudioPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
