...
namespace Umbraco.UmbracoStudio
{
    ...
    [ProvideToolWindow(typeof(ExplorerToolWindow))]
    [Guid(GuidList.guidUmbracoStudioPkgString)]
    public sealed class UmbracoStudioPackage : Package
    {
        /// <summary>
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidUmbracoStudioCmdSet, (int)PkgCmdIDList.cmdidUmbracoCmd);
                MenuCommand menuItem = new MenuCommand(ShowToolWindow, menuCommandID);
                mcs.AddCommand(menuItem);

                // Create the command for the tool window
                CommandID toolwndCommandID = new CommandID(GuidList.guidUmbracoStudioCmdSet, (int)PkgCmdIDList.cmdidUmbraco);
                MenuCommand menuToolWin = new MenuCommand(ShowToolWindow, toolwndCommandID);
                mcs.AddCommand( menuToolWin );

                // Server Explorer button 
                CommandID seCommandID = new CommandID(GuidList.guidSEPlusCmdSet, (int)PkgCmdIDList.cmdidUmbracoHello);
